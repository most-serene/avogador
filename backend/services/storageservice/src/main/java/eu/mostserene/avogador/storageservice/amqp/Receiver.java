...
public class Receiver {
    ...
    @RabbitListener(bindings = @QueueBinding(
            value = @Queue(value = "pingStorage", durable = "true"),
    ...
    @RabbitListener(bindings = @QueueBinding(
            value = @Queue(value = "courseCreationHandler", durable = "true"),
            exchange = @Exchange(value = "storage", type = ExchangeTypes.TOPIC),
    ...
    @RabbitListener(bindings = @QueueBinding(
            value = @Queue(value = "courseDeletionHandler", durable = "true"),
            exchange = @Exchange(value = "storage", type = ExchangeTypes.TOPIC),
    ...
    @RabbitListener(bindings = @QueueBinding(
            value = @Queue(value = "courseArchivingHandler", durable = "true"),
            exchange = @Exchange(value = "storage", type = ExchangeTypes.TOPIC),
    ...
    @RabbitListener(bindings = @QueueBinding(
            value = @Queue(value = "trialCreationHandler", durable = "true"),
            exchange = @Exchange(value = "storage", type = ExchangeTypes.TOPIC),
    ...
    @RabbitListener(bindings = @QueueBinding(
            value = @Queue(value = "trialDeletionHandler", durable = "true"),
            exchange = @Exchange(value = "storage", type = ExchangeTypes.TOPIC),
    ...
    @RabbitListener(bindings = @QueueBinding(
            value = @Queue(value = "logTrialEventHandler", durable = "true"),
            exchange = @Exchange(value = "storage", type = ExchangeTypes.TOPIC),
    ...
    @RabbitListener(bindings = @QueueBinding(
            value = @Queue(value = "exerciseCreationHandler", durable = "true"),
            exchange = @Exchange(value = "storage", type = ExchangeTypes.TOPIC),
    ...
    @RabbitListener(bindings = @QueueBinding(
            value = @Queue(value = "exerciseDeletionHandler", durable = "true"),
            exchange = @Exchange(value = "storage", type = ExchangeTypes.TOPIC),
    ...
    @RabbitListener(bindings = @QueueBinding(
            value = @Queue(value = "exerciseSimilaritySavingHandler", durable = "true"),
            exchange = @Exchange(value = "storage", type = ExchangeTypes.TOPIC),
    ...
    @RabbitListener(bindings = @QueueBinding(
            value = @Queue(value = "exerciseTemplateCreationHandler", durable = "true"),
            exchange = @Exchange(value = "storage", type = ExchangeTypes.TOPIC),
    ...
    @RabbitListener(bindings = @QueueBinding(
            value = @Queue(value = "submissionCreationHandler", durable = "true"),
            exchange = @Exchange(value = "storage", type = ExchangeTypes.TOPIC),
    ...
    @RabbitListener(bindings = @QueueBinding(
            value = @Queue(value = "submissionSaveOutputHandler", durable = "true"),
            exchange = @Exchange(value = "storage", type = ExchangeTypes.TOPIC),
    ...
    @RabbitListener(bindings = @QueueBinding(
            value = @Queue(value = "testcaseCreationHandler", durable = "true"),
            exchange = @Exchange(value = "storage", type = ExchangeTypes.TOPIC),
    ...
    @RabbitListener(bindings = @QueueBinding(
            value = @Queue(value = "testcaseDeleteHandler", durable = "true"),
            exchange = @Exchange(value = "storage", type = ExchangeTypes.TOPIC),
    ...
    @RabbitListener(bindings = @QueueBinding(
            value = @Queue(value = "projectCreationHandler", durable = "true"),
            exchange = @Exchange(value = "storage", type = ExchangeTypes.TOPIC),
