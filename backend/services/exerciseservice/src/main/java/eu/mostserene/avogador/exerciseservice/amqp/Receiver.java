...
public class Receiver {
    ...
    @RabbitListener(bindings = @QueueBinding(
            value = @Queue(value = "pingExercises", durable = "true", autoDelete = "false"),
    ...
    @RabbitListener(bindings = @QueueBinding(
            value = @Queue(value = "trialsDeletionHandler", durable = "true", autoDelete = "false"),
            exchange = @Exchange(value = "exercises", type = ExchangeTypes.TOPIC),
            key = "trials.delete"))
    ...
    @RabbitListener(bindings = @QueueBinding(
            value = @Queue(value = "submissionSavedHandler", durable = "true", autoDelete = "false"),
            exchange = @Exchange(value = "exercises", type = ExchangeTypes.TOPIC),
    ...
    @RabbitListener(bindings = @QueueBinding(
            value = @Queue(value = "submissionResultHandler", durable = "true", autoDelete = "false"),
            exchange = @Exchange(value = "exercises", type = ExchangeTypes.TOPIC),
    ...
    @RabbitListener(bindings = @QueueBinding(
            value = @Queue(value = "ProjectSubmissionSavedHandler", durable = "true", autoDelete = "false"),
            exchange = @Exchange(value = "exercises", type = ExchangeTypes.TOPIC),
    ...
    @RabbitListener(bindings = @QueueBinding(
            value = @Queue(value = "projectSubmissionResultHandler", durable = "true", autoDelete = "false"),
            exchange = @Exchange(value = "exercises", type = ExchangeTypes.TOPIC),
