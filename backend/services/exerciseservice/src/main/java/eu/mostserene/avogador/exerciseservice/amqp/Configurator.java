...
public class Configurator {
    ...
    @Bean
    Queue queue() {
        return new Queue("exercisesQueue", true);
    }
    ...
    @Bean
    Binding binding() {
        return new Binding("exercisesQueue", Binding.DestinationType.QUEUE, "exercises", "exercises.#", null);
    }
    ...
    public SimpleMessageListenerContainer messageListenerContainer() {
        ...
        container.setQueueNames("exercisesQueue");
