...
public class Configurator {
    ...
    @Bean
    Queue queue() {
        return new Queue("filesystemQueue", true);
    }

    @Bean
    Exchange exchange() {
        return new TopicExchange("filesystem", true, false);
    }

    @Bean
    Binding binding() {
        return new Binding("filesystemQueue", Binding.DestinationType.QUEUE, "filesystem", "fs.#", null);
    }
    ...
    public SimpleMessageListenerContainer messageListenerContainer() {
        ...
        container.setQueueNames("filesystemQueue");
